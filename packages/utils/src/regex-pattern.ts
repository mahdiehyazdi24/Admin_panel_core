export const regexPattern = {
  ...
  onlyEnglishNdOtherCharactersWithoutSpace: {
    value: /^[A-Za-z0-9!@#$%^&*(),.?":{}|<>_-]*$/,
    message: "فقط حروف انگلیسی مجاز است (بدون فاصله)",
  },
  lessThan50: {
    value: /^[0-9][0-9]?$|^50$/,
  ...
  postalCode: {
    value: /^[0-9]{8}$/,
    message: "کد پستی باید هشت رقم باشد.",
  },
  englishLetter: {
    value: /^[a-zA-Z]+$/,
    message: "لطفا فقط از حروف انگلیسی استفاده کنید",
  ...
  dockerImage: {
    ...
    message: "آدرس داکر ایمیج صحیح نمیباشد.",
  },
  spaceFarstCharacter: {
    value: /^[^\s].*/,
  ...
  priceWithNoZeroStart: {
    value: /^(?!0(\.0+)?$)(-?([1-9]\d*|0)(\.\d+)?)$/,
    message: "ابتدای قیمت نمیتواند صفر باشد.",
  },
  percent: {
    value: /^(100|[1-9]?[0-9])$/,
    message: "مقدار ورودی درصد نیست.",
  },
};
